...
inline void CompressedImage::set_frame_id(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:foxglove.CompressedImage.frame_id)
}
#endif
inline void CompressedImage::set_frame_id(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:foxglove.CompressedImage.frame_id)
}
inline void CompressedImage::set_frame_id(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:foxglove.CompressedImage.frame_id)
}
